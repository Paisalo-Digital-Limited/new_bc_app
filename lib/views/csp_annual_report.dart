  ...
  Widget build(BuildContext context) {
    return Table(
      columnWidths: {
        ...
        1: FractionColumnWidth(0.5),  // 50% of the table width
      ...
      children: [
        ...
        TableRow(
          ...
          children: [
            ...
            tableCell("${data.fold(0, (sum, item) => sum + item.payableToCsp.toInt())}", isHeader: true),
          ],
        ),      TableRow(
          decoration: BoxDecoration(color: Colors.white),
          children: [
            ...
            tableCell("${(data.fold(0, (sum, item) => sum + item.payableToCsp.toInt()) * 0.05).toStringAsFixed(2)}", isHeader: true),
          ],
        ),     TableRow(
          decoration: BoxDecoration(color: Colors.white),
          children: [
            ...
            tableCell("${(data.fold(0, (sum, item) => sum + item.payableToCsp.toInt()) * 0.95).toStringAsFixed(2)}", isHeader: true),
          ],
        ),
      ],
    );
